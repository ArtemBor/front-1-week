    ...
    return (
        <section className={styles.services} id={'servicesId'}>
            <div className={styles['services__top']}>
                ...
                <p className={`${'text'}`}>we transform ideas into impactful designs. From brand identities to digital experiences, our services blend creativity and strategy to make your vision stand out</p>
            </div>
            <div className={styles['services__img']}>
            <ul className={styles['services__img-list']}>
